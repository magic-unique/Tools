#
#  Be sure to run `pod spec lint MUFoundation.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
  Incloud UIKit/Foundation category, some tools.
                   DESC

  s.homepage     = "https://github.com/Magic-Unique/Tools"
  ...
  # Or just: s.author    = "冷秋"
  # s.authors            = { "冷秋" => "516563564@qq.com" }
  # s.social_media_url   = "http://twitter.com/冷秋"
  ...
  s.source       = { :git => "https://github.com/Magic-Unique/Tools.git", :tag => "#{s.version}" }
